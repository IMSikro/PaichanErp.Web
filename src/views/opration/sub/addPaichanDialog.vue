<template>
    <div class="add-paichan-container">
        <el-dialog v-model="isShowDialog" :width="800" draggable="">
            ...
            <div>
                <el-select clearable filterable v-model="deviceId" placeholder="请选择设备外键">
...
import { getOrderOrderIdDropdown, getDeviceDeviceIdDropdown, getSysUserOperatorUsersDropdown } from '/@/api/main/orderDetail';

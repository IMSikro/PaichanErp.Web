			...
			<el-form :model="ruleForm" ref="ruleFormRef" label-width="auto" :rules="rules">
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="配方" prop="produceFormulaId">
							<el-select clearable filterable v-model="ruleForm.produceFormulaId" placeholder="请选择配方">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="物料" prop="materialId">
							<el-select clearable filterable v-model="ruleForm.materialId" placeholder="请选择物料">
...
<script lang="ts" setup>
	...
	import { addProduceFormulaMaterial, updateProduceFormulaMaterial } from "/@/api/main/produceFormulaMaterial";
		...
		ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
			if (isValid) {
				...
				if (ruleForm.value.id == undefined || ruleForm.value.id == null || ruleForm.value.id == "" || ruleForm.value.id == 0) {
					await addProduceFormulaMaterial(values);
				} else {
					await updateProduceFormulaMaterial(values);
				}
				closeDialog();
			} else {
				ElMessage({

          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group style="margin-right:20px;">
                <el-button icon="ele-Search" @click="handleQuery" v-auth="'deviceType:page'"> 查询
                </el-button>
              ...
              <el-button-group>
                <el-button icon="ele-Plus" @click="openAddDeviceType" v-auth="'deviceType:add'"> 新增
                </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column label="操作" width="80" align="center" fixed="left" show-overflow-tooltip=""
          v-if="auth('deviceType:edit') || auth('deviceType:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditDeviceType(scope.row)"
              v-auth="'deviceType:edit'"> </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delDeviceType(scope.row)"
              v-auth="'deviceType:delete'"> </el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <editDialog ref="editDialogRef" :title="editDeviceTypeTitle" @reloadTable="handleQuery" />
    </el-card>
  </div>
</template>
...
import editDialog from '/@/views/main/deviceType/component/editDialog.vue'
import { pageDeviceType, deleteDeviceType } from '/@/api/main/deviceType';
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageDeviceType(Object.assign(queryParams.value, tableParams.value));

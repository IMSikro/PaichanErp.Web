			...
			<el-form :model="ruleForm" ref="ruleFormRef" label-width="auto" :rules="rules">
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="盘点单号" prop="stockTakeCode">
							<el-input v-model="ruleForm.stockTakeCode" placeholder="请输入盘点单号" maxlength="50" show-word-limit clearable />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="盘点日期" prop="stockTakeDate">
							<el-date-picker v-model="ruleForm.stockTakeDate" type="date" placeholder="盘点日期" />
							
						</el-form-item>
						
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="盘点数量" prop="stockTakeNumber">
							<el-input v-model="ruleForm.stockTakeNumber" placeholder="请输入盘点数量" maxlength="53" show-word-limit clearable />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="仓库" prop="storeId">
							<el-select clearable filterable v-model="ruleForm.storeId" placeholder="请选择仓库">
								<el-option v-for="(item,index) in storeStoreIdDropdownList" :key="index" :value="item.value" :label="item.label" />
...
<script lang="ts" setup>
	...
	import { addStockTake, updateStockTake } from "/@/api/main/stockTake";

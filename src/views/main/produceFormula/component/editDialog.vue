				...
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="配方编号" prop="produceFormulaCode">
							<el-input v-model="ruleForm.produceFormulaCode" placeholder="请输入配方编号" maxlength="100" show-word-limit clearable />
							
						</el-form-item>
						
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="产品外键" prop="produceId">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="配方名称" prop="produceFormulaName">
							<el-input v-model="ruleForm.produceFormulaName" placeholder="请输入配方名称" maxlength="100" show-word-limit clearable />

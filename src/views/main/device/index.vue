  ...
  <div class="device-container">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
            <el-form-item>
              <el-button-group style="margin-right:20px;">
                <el-button icon="ele-Search" @click="handleQuery" v-auth="'device:page'"> 查询 </el-button>
                <el-button icon="ele-Refresh" @click="() => queryParams = {}"> 重置 </el-button>
              </el-button-group>

              <el-button-group>
                <el-button icon="ele-Plus" @click="openAddDevice" v-auth="'device:add'"> 新增 </el-button>
                <el-button icon="ele-Plus" @click="openImportDevice" v-auth="'device:import'"> 导入
                </el-button>
              </el-button-group>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column prop="deviceTypeId" label="工艺设备" width="120" show-overflow-tooltip="">

<template>
  <div class="produceType-container">
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      ...
      <editDialog ref="editDialogRef" :title="editProduceTypeTitle" @reloadTable="handleQuery" />
    </el-card>
  </div>
</template>

<script lang="ts" setup="" name="produceType">
import { ref } from "vue";
...
import editDialog from '/@/views/main/produceType/component/editDialog.vue'
import { pageProduceType, deleteProduceType } from '/@/api/main/produceType';
...
const editProduceTypeTitle = ref("");
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageProduceType(Object.assign(queryParams.value, tableParams.value));
...
// 打开新增页面
const openAddProduceType = () => {
  editProduceTypeTitle.value = '添加产品类型';
  editDialogRef.value.openDialog({});
};

// 打开编辑页面
const openEditProduceType = (row: any) => {
  editProduceTypeTitle.value = '编辑产品类型';
  editDialogRef.value.openDialog(row);
};

// 删除
const delProduceType = (row: any) => {

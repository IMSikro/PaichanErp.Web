      ...
      <el-form :model="queryParams" ref="queryForm" labelWidth="90">
        <el-row>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="工艺标准编号">
              <el-input v-model="queryParams.processStandardCode" clearable="" placeholder="请输入工艺标准编号" />

            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="工艺标准名称">
              <el-input v-model="queryParams.processStandardName" clearable="" placeholder="请输入工艺标准名称" />
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="工艺项目">
              <el-select clearable="" filterable="" v-model="queryParams.processProjectId" placeholder="请选择工艺项目">
                <el-option v-for="(item, index) in  processProjectProcessProjectIdDropdownList" :key="index"
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group style="margin-right:20px;">
                <el-button icon="ele-Search" @click="handleQuery" v-auth="'processStandard:page'"> 查询
                </el-button>
              ...
              <el-button-group>
                <el-button icon="ele-Plus" @click="openAddProcessStandard" v-auth="'processStandard:add'"> 新增
                </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip=""
          v-if="auth('processStandard:edit') || auth('processStandard:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditProcessStandard(scope.row)"
              v-auth="'processStandard:edit'"> 编辑 </el-button>
      ...
      <editDialog ref="editDialogRef" :title="editProcessStandardTitle" @reloadTable="handleQuery" />
    </el-card>
  </div>
</template>

<script lang="ts" setup="" name="processStandard">
import { ref } from "vue";
...
import editDialog from '/@/views/main/processStandard/component/editDialog.vue'
import { pageProcessStandard, deleteProcessStandard } from '/@/api/main/processStandard';
...
const editProcessStandardTitle = ref("");
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageProcessStandard(Object.assign(queryParams.value, tableParams.value));
...
// 打开新增页面
const openAddProcessStandard = () => {
  editProcessStandardTitle.value = '添加工艺标准';
  editDialogRef.value.openDialog({});
};

// 打开编辑页面
const openEditProcessStandard = (row: any) => {
  editProcessStandardTitle.value = '编辑工艺标准';
...
const delProcessStandard = (row: any) => {
  ElMessageBox.confirm(`确定要删除吗?`, "提示", {
    ...
    .then(async () => {
      await deleteProcessStandard(row);
      handleQuery();

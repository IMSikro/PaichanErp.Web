<template>
	<div class="sys-userCenter-container">
			...
			<el-col :span="8" :xs="24">
				<el-card shadow="hover">
					<div class="account-center-avatarHolder">
						...
						<el-avatar :size="100" :src="userInfos.avatar" @click="openCropperDialog"
							v-loading="state.avatarLoading" element-loading-spinner="el-icon-Upload"
							element-loading-background="rgba(0, 0, 0, 0.2)" @mouseenter="mouseEnterAvatar"
					...
					<div class="image-signature">
						<el-image :src="userInfos.signature" fit="contain" alt="电子签名" loading="lazy"
							style="width: 100%; height: 100%"> </el-image>
					</div>
					<el-button icon="ele-Edit" type="primary" @click="openSignDialog" v-auth="'sysFile:uploadSignature'">
						电子签名 </el-button>
					<el-upload ref="uploadSignRef" action="" accept=".png" :limit="1" :show-file-list="false"
						:auto-upload="false" :on-change="uploadSignFile" :on-exceed="uploadSignFileExceed"
								...
								<el-row :gutter="35">
									...
									<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
										<el-form-item label="出生日期" prop="birthday"
											...
											<el-date-picker v-model="state.ruleFormBase.birthday" type="date"
												placeholder="出生日期" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
												class="w100" />
										</el-form-item>
									</el-col>
									<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
									...
									<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
										<el-form-item label="地址">
											<el-input v-model="state.ruleFormBase.address" placeholder="地址" clearable
												type="textarea" />
										</el-form-item>
									</el-col>
									<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
										<el-form-item label="备注">
											<el-input v-model="state.ruleFormBase.remark" placeholder="备注" clearable
												type="textarea" />
										</el-form-item>
									</el-col>
									<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
										<el-form-item>
											<el-button icon="ele-SuccessFilled" type="primary" @click="submitUserBase"
												v-auth="'sysUser:baseInfo'"> 保存基本信息 </el-button>
										</el-form-item>
									</el-col>
								</el-row>
							</el-form>
						...
						<el-tab-pane label="修改密码">
							<el-form ref="ruleFormPasswordRef" :model="state.ruleFormPassword" label-width="auto">
								<el-form-item label="当前密码" prop="passwordOld"
									...
									<el-input v-model="state.ruleFormPassword.passwordOld" type="password"
										autocomplete="off" />
								</el-form-item>
								<el-form-item label="新密码" prop="passwordNew"
									:rules="[{ required: true, message: '新密码不能为空', trigger: 'blur' }]">
									<el-input v-model="state.ruleFormPassword.passwordNew" type="password"
										autocomplete="off" />
								</el-form-item>
								...
								<el-form-item>
									...
									<el-button icon="ele-SuccessFilled" type="primary" @click="submitPassword"
										v-auth="'sysUser:changePwd'">确 定</el-button>
								</el-form-item>
							</el-form>
						</el-tab-pane>
		...
		<el-dialog v-model="state.signDialogVisible" draggable width="600px">
			<template #header>
				<div style="color: #fff">
					<el-icon size="16" style="margin-right: 3px; display: inline; vertical-align: middle"> <ele-EditPen />
					</el-icon>
					<span> 电子签名 </span>
				</div>
			</template>
			...
			<div style="margin-top: 10px">
				<div style="display: inline">画笔粗细：<el-input-number v-model="state.signOptions.minWidth" :min="0.5"
						:max="2.5" :step="0.1" size="small" /></div>
				<div style="display: inline; margin-left: 30px">画笔颜色：<el-color-picker v-model="state.signOptions.penColor"
						color-format="hex" size="default"> </el-color-picker></div>
			</div>
			<template #footer>

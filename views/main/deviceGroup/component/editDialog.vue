				...
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="分组编号" prop="groupCode">
							<el-input-number v-model="ruleForm.groupCode" placeholder="请输入分组编号" clearable />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="分组名称" prop="groupName">
							<el-input v-model="ruleForm.groupName" placeholder="请输入分组名称" maxlength="50" show-word-limit
								clearable />
